	...
	var win=function(n)
	{
		if(n==1)
		{
			...
			((arr[0][2]==1)&&(arr[1][2]==1)&&(arr[2][2]==1)))
			{
				...
				var winner=window.confirm("Player One has won the match Play Again");
		...
		else if(n==0)
		{
			...
			((arr[0][2]==2)&&(arr[1][2]==2)&&(arr[2][2]==2)))
			{
				...
				var winner=window.confirm("Player Two has won the Game Play again");
	...
	var check=function(a,b){  
		...
		{	
			...
			if(clickvar==0)//identifies first click i.e tile to be moved
			{
			...
			else if(clickvar==1)//second clicked identifies the click that specifies the dest position 
				{
					//alert("second click");
						var bRect = can.getBoundingClientRect();
